...
However, as described, they flatten the 12 leads prior to extracting features, and thus, do not exactly conform to the medical meaning of these features. Therefore, it results in two hurdles they acknowledged later in their paper.
...
Due to this inconsistency, we shall evaluate both \texttt{CatBoost} and \texttt{AdaBoost}.
