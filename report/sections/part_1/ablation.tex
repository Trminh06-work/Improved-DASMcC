...
In brief, we perform \texttt{StandardScaler()} and \texttt{SMOTE} prior to the train/test split stage, as this would introduce data leakage to the test set, and in fact, significantly improve the results, though it falsely report models' performance.
...
\texttt{AdaBoost} remains far behind at $40.6$ F1 and AUC $0.65$–$0.88$.
