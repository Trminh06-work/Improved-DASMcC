...
The model architecture is simpler than the above–mentioned model. In particular, after each linear transformation layer, we add non–linearity by use of \texttt{ReLU}, and neither normalisation nor more advanced techniques are applied.
